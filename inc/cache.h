...
// extern uint64_t llc_self_evictions;
...
class CACHE : public MEMORY {
  public:
    ...
    //Dynamic Set partioning logistics
    uint64_t llc_accesses;
    uint32_t dp_hash[NUM_CPUS];
    uint64_t dp_llc_sets_access_monitor[NUM_CPUS];
    uint64_t dp_llc_sets_misses_monitor[NUM_CPUS];
    uint64_t dp_llc_sets_selfEvictions_monitor[NUM_CPUS];
    uint32_t dp_llc_mapped_sets[NUM_CPUS][406];
    uint32_t dp_get_min_accesses_cpu(uint32_t current_cpu);
...
//	mshr_full = 0;
    ...
    llc_self_evictions = 0;

    //vedant: Dynamic Set partioning logistics
    uint64_t llc_accesses;
    uint32_t dp_hash[NUM_CPUS];
    uint64_t dp_llc_sets_access_monitor[NUM_CPUS];
    uint64_t dp_llc_sets_misses_monitor[NUM_CPUS];
    uint64_t dp_llc_sets_selfEvictions_monitor[NUM_CPUS];
    uint32_t dp_llc_mapped_sets[NUM_CPUS][1024];
    uint32_t dp_get_min_accesses_cpu(uint32_t current_cpu);
    ...
    uint32_t get_set(uint64_t address),
             get_way(uint64_t address, uint32_t set), get_sp_hashed_set(uint32_t set),get_dp_hashed_set(uint32_t set),get_wp_way(uint64_t address, uint32_t set),
